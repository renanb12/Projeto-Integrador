...
export function EntriesList() {
  ...
  const loadEntries = async () => {
    try {
      ...
      setError(error.message || 'Erro ao carregar entradas. Por favor, tente novamente.');
  ...
  const loadEntryProducts = async (entryId: string) => {
    try {
      ...
      setEntryProducts(prev => ({ ...prev, [entryId]: Array.isArray(products) ? products : [] }));
    } catch (error: any) {
      setError(error.message || 'Erro ao carregar produtos da entrada.');
          ...
          <div className="overflow-x-auto min-w-full">
            <table className="w-full">
              <thead className="bg-gray-800 text-white">
                <tr>
                  <th className="w-8"></th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">Data de Entrada</th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">Nº Nota</th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">CNPJ</th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">Fornecedor</th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">Total Produtos</th>
                  <th className="text-left p-4 font-medium whitespace-nowrap">Total Itens</th>
